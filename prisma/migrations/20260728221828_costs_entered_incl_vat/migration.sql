...
INSERT INTO "new_Inspection" ("completedAt", "contingencyPercent", "costsIncludeVat", "createdAt", "createdById", "endTime", "followUpInspections", "generalNote", "id", "immediateActions", "inspectionDate", "mainRisks", "organisationId", "overallConditionRating", "overallVerdict", "parentInspectionId", "propertyType", "protocolNumber", "purpose", "recommendedDiscountAmount", "revisionNumber", "startTime", "status", "updatedAt", "verdictJustification") SELECT "completedAt", "contingencyPercent", "costsIncludeVat", "createdAt", "createdById", "endTime", "followUpInspections", "generalNote", "id", "immediateActions", "inspectionDate", "mainRisks", "organisationId", "overallConditionRating", "overallVerdict", "parentInspectionId", "propertyType", "protocolNumber", "purpose", "recommendedDiscountAmount", "revisionNumber", "startTime", "status", "updatedAt", "verdictJustification" FROM "Inspection";
